...
public class Solution {
    ...
    public void transferFileContent(String fileFromPath, String fileToPath) throws /*FileNotFoundException*/Exception {
    ...
    private void deleteContentFileFrom(String path) {
